...
## 2026-03-19 실행 로그 (신뢰/법적 페이지 초안 반영)
...
- 공통 레이아웃 푸터 링크 추가:
  - `app/layout.tsx`
  - 링크: `/about`, `/privacy`, `/terms`

### B. 문서 반영
- `docs/SALJIP_HUB_WEEK1_SCOPE_2026-03-16.md`
  - 신뢰/법적 체크리스트 4개 항목 완료 처리
    - `/about`, `/privacy`, `/terms` 초안
    - 푸터 링크 노출
...
## 2026-03-19 실행 로그 (신뢰/법적 페이지 운영본 1차 보강)

### A. 코드 반영
- `app/about/page.tsx`
  - 운영본 문구로 재작성: 서비스 목적, 제공 기능, 데이터 출처/기준, 운영 원칙, 면책, 문의
  - 공고일/시행일/버전 메타 표시 추가
- `app/privacy/page.tsx` (우선 보강)
  - 공고일/시행일/버전 이력 표 반영
  - 수집항목·처리목적·보관기간 표 반영
  - 제3자 제공 원칙, 처리위탁/국외이전 표 반영
  - 권리행사 방법, 문의처(담당부서/이메일/책임자 placeholder) 반영
- `app/terms/page.tsx`
  - 서비스 내용/변경, 금지행위, 책임 한계, 이용 제한, 지식재산권, 준거법/관할 정리

### B. 문서 반영
- `docs/SALJIP_HUB_WEEK1_SCOPE_2026-03-16.md`
  - 신뢰/법적 체크리스트를 "초안"에서 "운영본 1차 보강" 상태로 갱신
